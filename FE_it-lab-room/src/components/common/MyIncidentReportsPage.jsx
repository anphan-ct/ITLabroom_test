...
const roleConfig = {
  student: {
    ...
    subtitle: "Danh sách các báo cáo sự cố bạn đã gửi và trạng thái xử lý hiện tại",
  },
  teacher: {
...
export default function MyIncidentReportsPage({ role = "student" }) {
  ...
  return (
    <AppShell role={role} title={config.title} subtitle={config.subtitle}>
      <SectionCard title={`Danh sách báo cáo (${pagination.total})`}>
        <DataTable
          columns={[
            { key: "id", title: "ID" },
