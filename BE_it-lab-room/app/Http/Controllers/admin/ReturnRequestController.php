...
use App\Enums\MachineCondition;
...
class ReturnRequestController extends Controller
{
    public function index(Request $request)
    {
        try {
            ...
            $query = ReturnRequest::with(['teacher.user', 'loanRequest.details.computer', 'details.computer']);
    ...
    public function confirm(ReturnRequestConfirmRequest $request, ReturnRequest $returnRequest)
    {
        ...
        try {
            ...
            foreach ($conditions as $cond) {
                ...
                $newStatus = ($tinhTrang === MachineCondition::TOT->value) 
                    ? ComputerStatus::ACTIVE->value 
